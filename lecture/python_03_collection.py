...
# a, b, c = list_d 위랑같음       +  갯수가 동일해야함 원소가 3개면 앞에 변수도 3개
...
abc.remove(3)   # 3이라는 값
print(abc)
e = abc.pop(0)      # 0번 인덱스 / e 에는 0번 인덱스의 값이 저장.
print(abc)
print(e)
...
print(abc.get("f")) # key가 없으면 None 출력(Error X)
